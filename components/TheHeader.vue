  ...
  <div class="header fixed top-0 w-full">
    <div class="relative bg-white">
      <div class="mx-auto px-4 sm:px-6">
        <div
          class="flex justify-between items-center border-b-2 border-gray-100 py-6  space-x-10"
        >
          ...
          <nav class="flex justify-end space-x-10">
            <a
              href="/posts"
          ...
          -->
              <div
                class="absolute z-10  transform -translate-x-90 mt-3 px-2 w-screen max-w-md sm:px-0"
                v-show="moreDisplay === true"
              >
                <div
